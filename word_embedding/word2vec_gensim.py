...
def train(data_path="../data/word_embedding/real/training", load_data=load_data_from_dir, model_path="../models/word2vec.model"):
    """
...
def test(model_path="../models/pretrained_word2vec.bin", word="thu_nhập"):
    """
    Test word2vec model
