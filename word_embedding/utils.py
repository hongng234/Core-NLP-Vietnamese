...
def clean_html_file(input_path, output_path, should_tokenize=True, tokenizer=None):
    """
...
def test_clean_file():
    data_path = '../data/word_embedding/real/html/html_data.txt'
    output_path = '../data/word_embedding/real/training/data.txt'
...
def test_clean_files_in_dir():
    ...
    import sys
    sys.path.insert(0, "../tokenization/")
